  ...
  <div class="col-md-4">
    <select id="product_categorie" name="product_categorie" class="form-control">
		...
		while($data1 = mysqli_fetch_array($qry1)){
            ...
            <li><a href="category.php?nameC=<?php echo $data1['id_Category']; ?> "><?php echo $data1['name_Category'] ?></a></li>
            <option name = "category" value="<?php echo $data1['id_Category']; ?>"><?php echo $data1['name_Category'] ?></option>
			  <?php } ?>
